...
make VERBOSE=1 CONFIG=Release LIBS="-lstdc++fs" LDFLAGS="-L/__w/DawDreamer/DawDreamer/alsa-lib/src" CXXFLAGS="-I../../alsa-lib/include -I../../curl/include -I../../freetype/include"
