...
install_name_tool -change /Library/Frameworks/Python.framework/Versions/3.9/Python intentionally_missing_python.dylib Builds/MacOSX/build/Release/dawdreamer.so
# otool -L Builds/MacOSX/build/Release/dawdreamer.so
...
# delocate-wheel --ignore-missing-dependencies --require-archs x86_64 -w repaired_wheel.whl dist/dawdreamer-0.5.8.1-cp39-cp39-macosx_10_15_universal2.whl
