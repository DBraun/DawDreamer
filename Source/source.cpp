...
PYBIND11_MODULE(dawdreamer, m)
{
    ...
    py::class_<SamplerProcessor, std::shared_ptr<SamplerProcessor>, ProcessorBase>(m, "SamplerProcessor")
        ...
        .def("set_parameter", &SamplerProcessor::setParameter)
        .def("get_plugin_parameter_size", &SamplerProcessor::wrapperGetPluginParameterSize)
        .def("get_plugin_parameters_description", &SamplerProcessor::getPluginParametersDescription)
