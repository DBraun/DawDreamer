...
class ProcessorBase : public juce::AudioProcessor
{
  public:
    //==============================================================================
    ProcessorBase(std::string newUniqueName = "") : AudioProcessor{}, myUniqueName{newUniqueName}
    {
    ...
    virtual bool setAutomation(std::string& parameterName, nb::ndarray<> input, std::uint32_t ppqn);
    virtual bool setAutomationByIndex(int& index, nb::ndarray<> input, std::uint32_t ppqn);
    ...
    virtual int getTotalNumOutputChannels() { return AudioProcessor::getTotalNumOutputChannels(); }

    virtual int getTotalNumInputChannels() { return AudioProcessor::getTotalNumInputChannels(); }
