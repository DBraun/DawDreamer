...
class FaustProcessor : public ProcessorBase
{
  public:
    ...
    bool setAutomation(std::string& parameterName, nb::ndarray<> input,
...
inline void create_bindings_for_faust_processor(nb::module_& m)
{
    ...
    faustProcessor
        ...
        .def("compile_signals", &FaustProcessor::compileSignals, arg("signals"),
             arg("argv") = nb::none(), returnPolicy)
        .def("compile_box", &FaustProcessor::compileBox, arg("box"), arg("argv") = nb::none(),
             returnPolicy)
