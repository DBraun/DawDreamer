...
Note that note-ons and note-offs are counted separately.")
        ...
        faust
            .def("boxInt", [](int val) { return BoxWrapper(boxInt(val)); }, arg("val"), "Blah", returnPolicy)
            .def("boxReal", [](double val) { return BoxWrapper(boxReal(val)); }, arg("val"), "Blah", returnPolicy)
            .def("boxWire", []() { return BoxWrapper(boxWire()); }, "Blah", returnPolicy)
            .def("boxCut", []() { return BoxWrapper(boxCut()); }, "Blah", returnPolicy)
        
            .def("boxSeq",[](BoxWrapper &box1, BoxWrapper &box2) { return BoxWrapper(boxSeq(box1, box2)); }, arg("box1"), arg("box2"), "The sequential composition of two blocks (e.g., A:B) expects: outputs(A)=inputs(B)", returnPolicy)

            .def("boxPar", [](BoxWrapper &box1, BoxWrapper &box2) { return BoxWrapper(boxPar(box1, box2)); }, arg("box1"), arg("box2"), "The parallel composition of two blocks (e.g., A,B). It places the two block-diagrams one on top of the other, without connections.", returnPolicy)
            .def("boxPar3", [](BoxWrapper &box1, BoxWrapper &box2, BoxWrapper &box3) { return BoxWrapper(boxPar3(box1, box2, box3)); }, arg("box1"), arg("box2"), arg("box3"), "The parallel composition of three blocks (e.g., A,B,C).", returnPolicy)
            .def("boxPar4", [](BoxWrapper &box1, BoxWrapper &box2, BoxWrapper &box3, BoxWrapper &box4) { return BoxWrapper(boxPar4(box1, box2, box3, box4)); }, arg("box1"), arg("box2"), arg("box3"), arg("box4"), "The parallel composition of four blocks (e.g., A,B,C,D).", returnPolicy)
            .def("boxPar5", [](BoxWrapper &box1, BoxWrapper &box2, BoxWrapper &box3, BoxWrapper &box4, BoxWrapper &box5) { return BoxWrapper(boxPar5(box1, box2, box3, box4, box5)); }, arg("box1"), arg("box2"), arg("box3"), arg("box4"), arg("box5"), "The parallel composition of five blocks (e.g., A,B,C,D,E).", returnPolicy)

            .def("boxSplit", [](BoxWrapper &box1, BoxWrapper &box2) { return BoxWrapper(boxSplit(box1, box2)); }, arg("box1"), arg("box2"), "The split composition (e.g., A<:B) operator is used to distribute the outputs of A to the inputs of B. The number of inputs of B must be a multiple of the number of outputs of A: outputs(A).k=inputs(B)", returnPolicy)
            .def("boxMerge", [](BoxWrapper &box1, BoxWrapper &box2) { return BoxWrapper(boxMerge(box1, box2)); }, arg("box1"), arg("box2"), "The merge composition (e.g., A:>B) is the dual of the split composition. The number of outputs of A must be a multiple of the number of inputs of B: outputs(A)=k.inputs(B)", returnPolicy)
                 
            .def("boxRoute", [](BoxWrapper &box1, BoxWrapper &box2, BoxWrapper &box3) { return BoxWrapper(boxRoute(box1, box2, box3)); }, arg("box_n"), arg("box_m"), arg("box_r"), "Blah", returnPolicy)
            ...
            .def("boxAdd", [](std::optional<BoxWrapper> box1, std::optional<BoxWrapper> box2) { return box1.has_value() && box2.has_value() ? BoxWrapper(boxAdd(*box1, *box2)) : BoxWrapper(boxAdd()); }, arg("box1")=py::none(), arg("box2")=py::none(), "Blah", returnPolicy)
            .def("boxSub", [](std::optional<BoxWrapper> box1, std::optional<BoxWrapper> box2) { return box1.has_value() && box2.has_value() ? BoxWrapper(boxSub(*box1, *box2)) : BoxWrapper(boxSub()); }, arg("box1")=py::none(), arg("box2")=py::none(), "Blah", returnPolicy)
            .def("boxMul", [](std::optional<BoxWrapper> box1, std::optional<BoxWrapper> box2) { return box1.has_value() && box2.has_value() ? BoxWrapper(boxMul(*box1, *box2)) : BoxWrapper(boxMul()); }, arg("box1")=py::none(), arg("box2")=py::none(), "Blah", returnPolicy)
            .def("boxDiv", [](std::optional<BoxWrapper> box1, std::optional<BoxWrapper> box2) { return box1.has_value() && box2.has_value() ? BoxWrapper(boxDiv(*box1, *box2)) : BoxWrapper(boxDiv()); }, arg("box1")=py::none(), arg("box2")=py::none(), "Blah", returnPolicy)
            .def("boxRem", [](std::optional<BoxWrapper> box1, std::optional<BoxWrapper> box2) { return box1.has_value() && box2.has_value() ? BoxWrapper(boxRem(*box1, *box2)) : BoxWrapper(boxRem()); }, arg("box1")=py::none(), arg("box2")=py::none(), "Blah", returnPolicy)

            .def("boxLeftShift", [](std::optional<BoxWrapper> box1, std::optional<BoxWrapper> box2) { return box1.has_value() && box2.has_value() ? BoxWrapper(boxLeftShift(*box1, *box2)) : BoxWrapper(boxLeftShift()); }, arg("box1")=py::none(), arg("box2")=py::none(), "Blah", returnPolicy)
            .def("boxLRightShift", [](std::optional<BoxWrapper> box1, std::optional<BoxWrapper> box2) { return box1.has_value() && box2.has_value() ? BoxWrapper(boxLRightShift(*box1, *box2)) : BoxWrapper(boxLRightShift()); }, arg("box1")=py::none(), arg("box2")=py::none(), "Blah", returnPolicy)
            .def("boxARightShift", [](std::optional<BoxWrapper> box1, std::optional<BoxWrapper> box2) { return box1.has_value() && box2.has_value() ? BoxWrapper(boxARightShift(*box1, *box2)) : BoxWrapper(boxARightShift()); }, arg("box1")=py::none(), arg("box2")=py::none(), "Blah", returnPolicy)

            .def("boxGT", [](std::optional<BoxWrapper> box1, std::optional<BoxWrapper> box2) { return box1.has_value() && box2.has_value() ? BoxWrapper(boxGT(*box1, *box2)) : BoxWrapper(boxGT()); }, arg("box1")=py::none(), arg("box2")=py::none(), "Blah", returnPolicy)
            .def("boxLT", [](std::optional<BoxWrapper> box1, std::optional<BoxWrapper> box2) { return box1.has_value() && box2.has_value() ? BoxWrapper(boxLT(*box1, *box2)) : BoxWrapper(boxLT()); }, arg("box1")=py::none(), arg("box2")=py::none(), "Blah", returnPolicy)
            .def("boxGE", [](std::optional<BoxWrapper> box1, std::optional<BoxWrapper> box2) { return box1.has_value() && box2.has_value() ? BoxWrapper(boxGE(*box1, *box2)) : BoxWrapper(boxGE()); }, arg("box1")=py::none(), arg("box2")=py::none(), "Blah", returnPolicy)
            .def("boxLE", [](std::optional<BoxWrapper> box1, std::optional<BoxWrapper> box2) { return box1.has_value() && box2.has_value() ? BoxWrapper(boxLE(*box1, *box2)) : BoxWrapper(boxLE()); }, arg("box1")=py::none(), arg("box2")=py::none(), "Blah", returnPolicy)
            .def("boxEQ", [](std::optional<BoxWrapper> box1, std::optional<BoxWrapper> box2) { return box1.has_value() && box2.has_value() ? BoxWrapper(boxEQ(*box1, *box2)) : BoxWrapper(boxEQ()); }, arg("box1")=py::none(), arg("box2")=py::none(), "Blah", returnPolicy)
            .def("boxNE", [](std::optional<BoxWrapper> box1, std::optional<BoxWrapper> box2) { return box1.has_value() && box2.has_value() ? BoxWrapper(boxNE(*box1, *box2)) : BoxWrapper(boxNE()); }, arg("box1")=py::none(), arg("box2")=py::none(), "Blah", returnPolicy)

            .def("boxAND", [](std::optional<BoxWrapper> box1, std::optional<BoxWrapper> box2) { return box1.has_value() && box2.has_value() ? BoxWrapper(boxAND(*box1, *box2)) : BoxWrapper(boxAND()); }, arg("box1")=py::none(), arg("box2")=py::none(), "Blah", returnPolicy)
            .def("boxOR", [](std::optional<BoxWrapper> box1, std::optional<BoxWrapper> box2) { return box1.has_value() && box2.has_value() ? BoxWrapper(boxOR(*box1, *box2)) : BoxWrapper(boxOR()); }, arg("box1")=py::none(), arg("box2")=py::none(), "Blah", returnPolicy)
            .def("boxXOR", [](std::optional<BoxWrapper> box1, std::optional<BoxWrapper> box2) { return box1.has_value() && box2.has_value() ? BoxWrapper(boxXOR(*box1, *box2)) : BoxWrapper(boxXOR()); }, arg("box1")=py::none(), arg("box2")=py::none(), "Blah", returnPolicy)

            .def("boxAbs", [](std::optional<BoxWrapper> box1) { return BoxWrapper(box1.has_value() ? boxAbs(*box1) : boxAbs()); }, arg("box1")=py::none(), "Blah", returnPolicy)
            .def("boxAcos", [](std::optional<BoxWrapper> box1) { return BoxWrapper(box1.has_value() ? boxAcos(*box1) : boxAcos()); }, arg("box1")=py::none(), "Blah", returnPolicy)
            .def("boxTan", [](std::optional<BoxWrapper> box1) { return BoxWrapper(box1.has_value() ? boxTan(*box1) : boxTan()); }, arg("box1")=py::none(), "Blah", returnPolicy)
            .def("boxSqrt", [](std::optional<BoxWrapper> box1) { return BoxWrapper(box1.has_value() ? boxSqrt(*box1) : boxSqrt()); }, arg("box1")=py::none(), "Blah", returnPolicy)
            .def("boxSin", [](std::optional<BoxWrapper> box1) { return BoxWrapper(box1.has_value() ? boxSin(*box1) : boxSin()); }, arg("box1")=py::none(), "Blah", returnPolicy)
            .def("boxRint", [](std::optional<BoxWrapper> box1) { return BoxWrapper(box1.has_value() ? boxRint(*box1) : boxRint()); }, arg("box1")=py::none(), "Blah", returnPolicy)
            .def("boxLog", [](std::optional<BoxWrapper> box1) { return BoxWrapper(box1.has_value() ? boxLog(*box1) : boxLog()); }, arg("box1")=py::none(), "Blah", returnPolicy)
            .def("boxLog10", [](std::optional<BoxWrapper> box1) { return BoxWrapper(box1.has_value() ? boxLog10(*box1) : boxLog10()); }, arg("box1")=py::none(), "Blah", returnPolicy)
            .def("boxFloor", [](std::optional<BoxWrapper> box1) { return BoxWrapper(box1.has_value() ? boxFloor(*box1) : boxFloor()); }, arg("box1")=py::none(), "Blah", returnPolicy)
            .def("boxExp", [](std::optional<BoxWrapper> box1) { return BoxWrapper(box1.has_value() ? boxExp(*box1) : boxExp()); }, arg("box1")=py::none(), "Blah", returnPolicy)
            .def("boxExp10", [](std::optional<BoxWrapper> box1) { return BoxWrapper(box1.has_value() ? boxExp10(*box1) : boxExp10()); }, arg("box1")=py::none(), "Blah", returnPolicy)
            .def("boxCos", [](std::optional<BoxWrapper> box1) { return BoxWrapper(box1.has_value() ? boxCos(*box1) : boxCos()); }, arg("box1")=py::none(), "Blah", returnPolicy)
            .def("boxCeil", [](std::optional<BoxWrapper> box1) { return BoxWrapper(box1.has_value() ? boxCeil(*box1) : boxCeil()); }, arg("box1")=py::none(), "Blah", returnPolicy)
            .def("boxAtan", [](std::optional<BoxWrapper> box1) { return BoxWrapper(box1.has_value() ? boxAtan(*box1) : boxAtan()); }, arg("box1")=py::none(), "Blah", returnPolicy)
            .def("boxAsin", [](std::optional<BoxWrapper> box1) { return BoxWrapper(box1.has_value() ? boxAsin(*box1) : boxAsin()); }, arg("box1")=py::none(), "Blah", returnPolicy)

            .def("boxRemainder", [](std::optional<BoxWrapper> box1, std::optional<BoxWrapper> box2) { return box1.has_value() && box2.has_value() ? BoxWrapper(boxRemainder(*box1, *box2)) : BoxWrapper(boxRemainder()); }, arg("box1")=py::none(), arg("box2")=py::none(), "Blah", returnPolicy)
            .def("boxPow", [](std::optional<BoxWrapper> box1, std::optional<BoxWrapper> box2) { return box1.has_value() && box2.has_value() ? BoxWrapper(boxPow(*box1, *box2)) : BoxWrapper(boxPow()); }, arg("box1")=py::none(), arg("box2")=py::none(), "Blah", returnPolicy)
            .def("boxMin", [](std::optional<BoxWrapper> box1, std::optional<BoxWrapper> box2) { return box1.has_value() && box2.has_value() ? BoxWrapper(boxMin(*box1, *box2)) : BoxWrapper(boxMin()); }, arg("box1")=py::none(), arg("box2")=py::none(), "Blah", returnPolicy)
            .def("boxMax", [](std::optional<BoxWrapper> box1, std::optional<BoxWrapper> box2) { return box1.has_value() && box2.has_value() ? BoxWrapper(boxMax(*box1, *box2)) : BoxWrapper(boxMax()); }, arg("box1")=py::none(), arg("box2")=py::none(), "Blah", returnPolicy)
            .def("boxFmod", [](std::optional<BoxWrapper> box1, std::optional<BoxWrapper> box2) { return box1.has_value() && box2.has_value() ? BoxWrapper(boxFmod(*box1, *box2)) : BoxWrapper(boxFmod()); }, arg("box1")=py::none(), arg("box2")=py::none(), "Blah", returnPolicy)
            .def("boxAtan2", [](std::optional<BoxWrapper> box1, std::optional<BoxWrapper> box2) { return box1.has_value() && box2.has_value() ? BoxWrapper(boxAtan2(*box1, *box2)) : BoxWrapper(boxAtan2()); }, arg("box1")=py::none(), arg("box2")=py::none(), "Blah", returnPolicy)

            .def("boxRec", [](BoxWrapper &box1, BoxWrapper &box2) { return BoxWrapper(boxRec(box1, box2)); }, arg("box1"), arg("box2"), "The recursive composition (e.g., A~B) is used to create cycles in the block-diagram in order to express recursive computations. It is the most complex operation in terms of connections: outputs(A)≥inputs(B) and inputs(A)≥outputs(B)", returnPolicy)

            .def("boxButton", [](std::string &label) { return BoxWrapper(boxButton(label)); }, arg("label"), "Blah", returnPolicy)
            .def("boxCheckbox", [](std::string &label) { return BoxWrapper(boxCheckbox(label)); }, arg("label"), "Blah", returnPolicy)

            .def("boxVSlider", [](std::string &label, BoxWrapper &boxInit, BoxWrapper &boxMin, BoxWrapper &boxMax, BoxWrapper &boxStep)
                 { return BoxWrapper(boxVSlider(label, boxInit, boxMin, boxMax, boxStep)); }, arg("label"), arg("init"), arg("min"), arg("max"), arg("step"), "Blah", returnPolicy)
            .def("boxVSlider", [](std::string &label, float init, float minVal, float maxVal, float step)
                 { return BoxWrapper(boxVSlider(label, boxReal(init), boxReal(minVal), boxReal(maxVal), boxReal(step))); }, arg("label"), arg("init"), arg("min"), arg("max"), arg("step"), "Blah", returnPolicy)
            .def("boxHSlider", [](std::string &label, BoxWrapper &boxInit, BoxWrapper &boxMin, BoxWrapper &boxMax, BoxWrapper &boxStep)
                 { return BoxWrapper(boxHSlider(label, boxInit, boxMin, boxMax, boxStep)); }, arg("label"), arg("init"), arg("min"), arg("max"), arg("step"), "Blah", returnPolicy)
            .def("boxHSlider", [](std::string &label, float init, float minVal, float maxVal, float step)
                 { return BoxWrapper(boxHSlider(label, boxReal(init), boxReal(minVal), boxReal(maxVal), boxReal(step))); }, arg("label"), arg("init"), arg("min"), arg("max"), arg("step"), "Blah", returnPolicy)

            .def("boxNumEntry", [](std::string &label, BoxWrapper &boxInit, BoxWrapper &boxMin, BoxWrapper &boxMax, BoxWrapper &boxStep)
                 { return BoxWrapper(boxNumEntry(label, boxInit, boxMin, boxMax, boxStep)); }, arg("label"), arg("init"), arg("min"), arg("max"), arg("step"), "Blah", returnPolicy)
            .def("boxNumEntry", [](std::string &label, float init, float minVal, float maxVal, float step)
                 { return BoxWrapper(boxNumEntry(label, boxReal(init), boxReal(minVal), boxReal(maxVal), boxReal(step))); }, arg("label"), arg("init"), arg("min"), arg("max"), arg("step"), "Blah", returnPolicy)

            .def("boxVBargraph", [](std::string &label, BoxWrapper &boxMin, BoxWrapper &boxMax, BoxWrapper &box)
                 { return BoxWrapper(boxVBargraph(label, boxMin, boxMax, box)); }, arg("label"), arg("min"), arg("max"), arg("step"), "Blah", returnPolicy)
            .def("boxHBargraph", [](std::string &label, BoxWrapper &boxMin, BoxWrapper &boxMax, BoxWrapper &box)
                 { return BoxWrapper(boxHBargraph(label, boxMin, boxMax, box)); }, arg("label"), arg("min"), arg("max"), arg("step"), "Blah", returnPolicy)

            .def("boxAttach", [](std::optional<BoxWrapper> s1, std::optional<BoxWrapper> s2)
                 { return BoxWrapper((s1.has_value() && s2.has_value()) ? boxAttach(*s1, *s2) : boxAttach()); }, arg("box1")=py::none(), arg("box2")=py::none(), "Blah", returnPolicy)

            .def("boxSampleRate", []() { return BoxWrapper(boxMin(boxReal(192000.0),
                                                                  boxMax(boxReal(1.0),
                                                                         boxFConst(SType::kSInt, "fSamplingFreq", "<math.h>")))); }, "Blah", returnPolicy)
            .def("boxBufferSize", []() { return BoxWrapper(boxFVar(SType::kSInt, "count", "<math.h>")); }, "Blah", returnPolicy)
        ...
        // SIGNAL API
            .def("sigInt", [](int val) { return SigWrapper(sigInt(val)); }, arg("val"), "Blah", returnPolicy)
            .def("sigReal", [](double val) { return SigWrapper(sigReal(val)); }, arg("val"), "Blah", returnPolicy)
            .def("sigInput", [](int index) { return SigWrapper(sigInput(index)); }, arg("index"), "Blah", returnPolicy)
            .def("sigDelay", [](SigWrapper &sig1, SigWrapper &sig2) { return SigWrapper(sigDelay(sig1, sig2)); }, arg("sig1"), arg("sig2"), "Blah", returnPolicy)

            .def("sigIntCast", [](SigWrapper &sig1) { return SigWrapper(sigIntCast(sig1)); }, arg("sig1"), "Blah", returnPolicy)
            .def("sigFloatCast", [](SigWrapper &sig1) { return SigWrapper(sigFloatCast(sig1)); }, arg("sig1"), "Blah", returnPolicy)
            ...
            .def("sigAdd", [](SigWrapper &sig1, SigWrapper &sig2) { return SigWrapper(sigAdd(sig1, sig2)); }, arg("sig1"), arg("sig2"), "Blah", returnPolicy)
            .def("sigSub", [](SigWrapper &sig1, SigWrapper &sig2) { return SigWrapper(sigSub(sig1, sig2)); }, arg("sig1"), arg("sig2"), "Blah", returnPolicy)
            .def("sigMul", [](SigWrapper &sig1, SigWrapper &sig2) { return SigWrapper(sigMul(sig1, sig2)); }, arg("sig1"), arg("sig2"), "Blah", returnPolicy)
            .def("sigDiv", [](SigWrapper &sig1, SigWrapper &sig2) { return SigWrapper(sigDiv(sig1, sig2)); }, arg("sig1"), arg("sig2"), "Blah", returnPolicy)
            .def("sigRem", [](SigWrapper &sig1, SigWrapper &sig2) { return SigWrapper(sigRem(sig1, sig2)); }, arg("sig1"), arg("sig2"), "Blah", returnPolicy)
        
            .def("sigLeftShift", [](SigWrapper &sig1, SigWrapper &sig2) { return SigWrapper(sigLeftShift(sig1, sig2)); }, arg("sig1"), arg("sig2"), "Blah", returnPolicy)
            .def("sigLRightShift", [](SigWrapper &sig1, SigWrapper &sig2) { return SigWrapper(sigLRightShift(sig1, sig2)); }, arg("sig1"), arg("sig2"), "Blah", returnPolicy)
            .def("sigARightShift", [](SigWrapper &sig1, SigWrapper &sig2) { return SigWrapper(sigARightShift(sig1, sig2)); }, arg("sig1"), arg("sig2"), "Blah", returnPolicy)

            .def("sigGT", [](SigWrapper &sig1, SigWrapper &sig2) { return SigWrapper(sigGT(sig1, sig2)); }, arg("sig1"), arg("sig2"), "Blah", returnPolicy)
            .def("sigLT", [](SigWrapper &sig1, SigWrapper &sig2) { return SigWrapper(sigLT(sig1, sig2)); }, arg("sig1"), arg("sig2"), "Blah", returnPolicy)
            .def("sigGE", [](SigWrapper &sig1, SigWrapper &sig2) { return SigWrapper(sigGE(sig1, sig2)); }, arg("sig1"), arg("sig2"), "Blah", returnPolicy)
            .def("sigLE", [](SigWrapper &sig1, SigWrapper &sig2) { return SigWrapper(sigLE(sig1, sig2)); }, arg("sig1"), arg("sig2"), "Blah", returnPolicy)
            .def("sigEQ", [](SigWrapper &sig1, SigWrapper &sig2) { return SigWrapper(sigEQ(sig1, sig2)); }, arg("sig1"), arg("sig2"), "Blah", returnPolicy)
            .def("sigNE", [](SigWrapper &sig1, SigWrapper &sig2) { return SigWrapper(sigNE(sig1, sig2)); }, arg("sig1"), arg("sig2"), "Blah", returnPolicy)

            .def("sigAND", [](SigWrapper &sig1, SigWrapper &sig2) { return SigWrapper(sigAND(sig1, sig2)); }, arg("sig1"), arg("sig2"), "Blah", returnPolicy)
            .def("sigOR", [](SigWrapper &sig1, SigWrapper &sig2) { return SigWrapper(sigOR(sig1, sig2)); }, arg("sig1"), arg("sig2"), "Blah", returnPolicy)
            .def("sigXOR", [](SigWrapper &sig1, SigWrapper &sig2) { return SigWrapper(sigXOR(sig1, sig2)); }, arg("sig1"), arg("sig2"), "Blah", returnPolicy)

            .def("sigAbs", [](SigWrapper &sig1) { return SigWrapper(sigAbs(sig1)); }, arg("sig1"), "Blah", returnPolicy)
            .def("sigAcos", [](SigWrapper &sig1) { return SigWrapper(sigAcos(sig1)); }, arg("sig1"), "Blah", returnPolicy)
            .def("sigTan", [](SigWrapper &sig1) { return SigWrapper(sigTan(sig1)); }, arg("sig1"), "Blah", returnPolicy)
            .def("sigSqrt", [](SigWrapper &sig1) { return SigWrapper(sigSqrt(sig1)); }, arg("sig1"), "Blah", returnPolicy)
            .def("sigSin", [](SigWrapper &sig1) { return SigWrapper(sigSin(sig1)); }, arg("sig1"), "Blah", returnPolicy)
            .def("sigRint", [](SigWrapper &sig1) { return SigWrapper(sigRint(sig1)); }, arg("sig1"), "Blah", returnPolicy)
            .def("sigLog", [](SigWrapper &sig1) { return SigWrapper(sigLog(sig1)); }, arg("sig1"), "Blah", returnPolicy)
            .def("sigLog10", [](SigWrapper &sig1) { return SigWrapper(sigLog10(sig1)); }, arg("sig1"), "Blah", returnPolicy)
            .def("sigFloor", [](SigWrapper &sig1) { return SigWrapper(sigFloor(sig1)); }, arg("sig1"), "Blah", returnPolicy)
            .def("sigExp", [](SigWrapper &sig1) { return SigWrapper(sigExp(sig1)); }, arg("sig1"), "Blah", returnPolicy)
            .def("sigExp10", [](SigWrapper &sig1) { return SigWrapper(sigExp10(sig1)); }, arg("sig1"), "Blah", returnPolicy)
            .def("sigCos", [](SigWrapper &sig1) { return SigWrapper(sigCos(sig1)); }, arg("sig1"), "Blah", returnPolicy)
            .def("sigCeil", [](SigWrapper &sig1) { return SigWrapper(sigCeil(sig1)); }, arg("sig1"), "Blah", returnPolicy)
            .def("sigAtan", [](SigWrapper &sig1) { return SigWrapper(sigAtan(sig1)); }, arg("sig1"), "Blah", returnPolicy)
            .def("sigAsin", [](SigWrapper &sig1) { return SigWrapper(sigAsin(sig1)); }, arg("sig1"), "Blah", returnPolicy)
        
            .def("sigRemainder", [](SigWrapper &sig1, SigWrapper &sig2) { return SigWrapper(sigRemainder(sig1, sig2)); }, arg("sig1"), arg("sig2"), "Blah", returnPolicy)
            .def("sigPow", [](SigWrapper &sig1, SigWrapper &sig2) { return SigWrapper(sigPow(sig1, sig2)); }, arg("sig1"), arg("sig2"), "Blah", returnPolicy)
            .def("sigMin", [](SigWrapper &sig1, SigWrapper &sig2) { return SigWrapper(sigMin(sig1, sig2)); }, arg("sig1"), arg("sig2"), "Blah", returnPolicy)
            .def("sigMax", [](SigWrapper &sig1, SigWrapper &sig2) { return SigWrapper(sigMax(sig1, sig2)); }, arg("sig1"), arg("sig2"), "Blah", returnPolicy)
            .def("sigFmod", [](SigWrapper &sig1, SigWrapper &sig2) { return SigWrapper(sigFmod(sig1, sig2)); }, arg("sig1"), arg("sig2"), "Blah", returnPolicy)
            .def("sigAtan2", [](SigWrapper &sig1, SigWrapper &sig2) { return SigWrapper(sigAtan2(sig1, sig2)); }, arg("sig1"), arg("sig2"), "Blah", returnPolicy)

            .def("sigSelf", []() { return SigWrapper(sigSelf()); }, "Blah", returnPolicy)
            .def("sigRecursion", [](SigWrapper &sig1) { return SigWrapper(sigRecursion(sig1)); }, arg("sig"), "Blah", returnPolicy)
        
            .def("sigButton", [](std::string &label) { return SigWrapper(sigButton(label)); }, arg("label"), "Blah", returnPolicy)
            .def("sigCheckbox", [](std::string &label) { return SigWrapper(sigCheckbox(label)); }, arg("label"), "Blah", returnPolicy)

            .def("sigVSlider", [](std::string &label, SigWrapper &sigInit, SigWrapper &sigMin, SigWrapper &sigMax, SigWrapper &sigStep)
                 { return SigWrapper(sigVSlider(label, sigInit, sigMin, sigMax, sigStep)); }, arg("label"), arg("init"), arg("min"), arg("max"), arg("step"), "Blah", returnPolicy)
            .def("sigHSlider", [](std::string &label, SigWrapper &sigInit, SigWrapper &sigMin, SigWrapper &sigMax, SigWrapper &sigStep)
                 { return SigWrapper(sigHSlider(label, sigInit, sigMin, sigMax, sigStep)); }, arg("label"), arg("init"), arg("min"), arg("max"), arg("step"), "Blah", returnPolicy)

            .def("sigNumEntry", [](std::string &label, SigWrapper &sigInit, SigWrapper &sigMin, SigWrapper &sigMax, SigWrapper &sigStep)
                 { return SigWrapper(sigNumEntry(label, sigInit, sigMin, sigMax, sigStep)); }, arg("label"), arg("init"), arg("min"), arg("max"), arg("step"), "Blah", returnPolicy)

            .def("sigVBargraph", [](std::string &label, SigWrapper &sigMin, SigWrapper &sigMax, SigWrapper &sig)
                 { return SigWrapper(sigVBargraph(label, sigMin, sigMax, sig)); }, arg("label"), arg("min"), arg("max"), arg("step"), "Blah", returnPolicy)
            .def("sigHBargraph", [](std::string &label, SigWrapper &sigMin, SigWrapper &sigMax, SigWrapper &sig)
                 { return SigWrapper(sigHBargraph(label, sigMin, sigMax, sig)); }, arg("label"), arg("min"), arg("max"), arg("step"), "Blah", returnPolicy)

            .def("sigAttach", [](SigWrapper &s1, SigWrapper &s2)
                 { return SigWrapper(sigAttach(s1, s2)); }, arg("sig1"), arg("sig2"), "Blah", returnPolicy)
        
            .def("sigSampleRate", []() { return SigWrapper(sigMin(sigReal(192000.0),
                                                                  sigMax(sigReal(1.0),
                                                                         sigFConst(SType::kSInt, "fSamplingFreq", "<math.h>")))); }, "Blah", returnPolicy)
            .def("sigBufferSize", []() { return SigWrapper(sigFVar(SType::kSInt, "count", "<math.h>")); }, "Blah", returnPolicy)
