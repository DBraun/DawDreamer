...
class PlaybackWarpProcessor : public ProcessorBase
{
  public:
    ...
    PlaybackWarpProcessor(std::string newUniqueName, nb::ndarray<> input, double sr,
                          double data_sr);
    ...
    void setData(nb::ndarray<> input, double data_sr);
    ...
    void setWarpMarkers(nb::ndarray<> input);
