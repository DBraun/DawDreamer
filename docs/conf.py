#
# DawDreamer Documentation build configuration file, created by
...
project = "DawDreamer"
copyright = datetime.datetime.now().strftime("%Y") + ", David Braun"
author = "David Braun"
...
htmlhelp_basename = "DawDreamerdoc"
...
latex_documents = [
    (master_doc, "DawDreamer.tex", "DawDreamer Documentation", "David Braun", "manual"),
]
...
man_pages = [(master_doc, "DawDreamer", "DawDreamer Documentation", [author], 1)]
