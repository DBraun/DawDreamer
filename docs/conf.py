...
latex_documents = [
    (master_doc, 'DawDreamer.tex', u'DawDreamer Documentation',
     u'David Braun', 'manual'),
]
...
man_pages = [
    (master_doc, 'DawDreamer', u'DawDreamer Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'DawDreamer', u'DawDreamer Documentation',
     author, 'DawDreamer', 'One line description of project.',
     'Miscellaneous'),
]
